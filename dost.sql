...
CREATE TABLE IF NOT EXISTS `dost`.`scholarship` (
  ...
  `end_year` YEAR GENERATED ALWAYS AS (award_year+4) VIRTUAL,
...
-- -----------------------------------------------------
-- Table `dost`.`certificate_of_grade`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dost`.`certificate_of_grade` (
